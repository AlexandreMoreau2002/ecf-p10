 ...
 */
final class Version20230629115522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE emprunteur (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, nom VARCHAR(190) NOT NULL, prenom VARCHAR(190) NOT NULL, telephone VARCHAR(190) NOT NULL, UNIQUE INDEX UNIQ_952067DEA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
